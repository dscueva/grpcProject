...
func (c *sumServiceClient) Add(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumReply, error) {
...
func (UnimplementedSumServiceServer) Add(context.Context, *SumRequest) (*SumReply, error) {
